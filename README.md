...
local ItemCategories = {
	...
	{name="🎈 БАЛОНИ/СВЯТО", color=Color3.fromRGB(180,0,120), items={
		"4th of July Hat","Balloon","Bat Balloon","Basketball","Beach Ball","Bear Trap",
		"Bunny Balloon","Clown","Firework","Firework Cake","Firework Cone","Firework Mortar",
		"Ghost Balloon","Hockey Mask","July 4th Firework","Roman Candle","Skull Balloon",
		"Snowflake Balloon","Sombrero Hat",
	}},
